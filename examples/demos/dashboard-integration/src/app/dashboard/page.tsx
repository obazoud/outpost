    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Loading your event destinations overview...</p>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-green-700">
                <p>Your account has been created and you're ready to start managing event destinations. Click "Event Destinations" to get started!</p>
              </div>
            </div>
          </div>
        </div>
              ...
              {overview.destinations.length === 0 ? (
                ...
                <div className="space-y-2">
                  {overview.destinations.map((dest) => (
                    ...
                    >
                      <div>
                        <span className="text-sm font-medium text-gray-900">{dest.type}</span>
                        {dest.config.url && (
                          <p className="text-xs text-gray-600">{dest.config.url}</p>
                        )}
                      </div>
