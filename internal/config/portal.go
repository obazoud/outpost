...
type PortalConfig struct {
	...
	RefererURL             string `yaml:"referer_url" env:"PORTAL_REFERER_URL" desc:"The expected Referer URL for accessing the portal. This is a security measure. Example: 'https://admin.example.com'." required:"Y"`
	...
	OrgName                string `yaml:"org_name" env:"PORTAL_ORGANIZATION_NAME" desc:"Organization name displayed in the Outpost Portal. Defaults to 'Acme' if not set in 'InitDefaults'." required:"N"`
	...
	DisableOutpostBranding bool   `yaml:"disable_outpost_branding" env:"PORTAL_DISABLE_OUTPOST_BRANDING" desc:"If true, disables Outpost branding in the portal. Defaults to false (branding enabled)." required:"N"`
}
