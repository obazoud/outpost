...
class Destinations(BaseSDK):
    ...
    def list(
        ...
        *,
        security: Union[
            models.ListTenantDestinationsSecurity,
            models.ListTenantDestinationsSecurityTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListTenantDestinationsSecurity
            ),
    ...
    def create(
        ...
        *,
        security: Union[
            models.CreateTenantDestinationSecurity,
            models.CreateTenantDestinationSecurityTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.CreateTenantDestinationSecurity
            ),
    ...
    def get(
        ...
        *,
        security: Union[
            models.GetTenantDestinationSecurity,
            models.GetTenantDestinationSecurityTypedDict,
        ],
        destination_id: str,
        tenant_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.GetTenantDestinationSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def update(
        ...
        *,
        security: Union[
            models.UpdateTenantDestinationSecurity,
            models.UpdateTenantDestinationSecurityTypedDict,
        ],
        destination_id: str,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.UpdateTenantDestinationSecurity
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.UpdateTenantDestinationResponse
            )
        if utils.match_response(http_res, ["401", "403", "407"], "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.UnauthorizedErrorData
    ...
    def delete(
        ...
        *,
        security: Union[
            models.DeleteTenantDestinationSecurity,
            models.DeleteTenantDestinationSecurityTypedDict,
        ],
        destination_id: str,
        tenant_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.DeleteTenantDestinationSecurity
            ),
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.SuccessResponse)
        if utils.match_response(http_res, ["401", "403", "407"], "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.UnauthorizedErrorData
            )
    ...
    def enable(
        ...
        *,
        security: Union[
            models.EnableTenantDestinationSecurity,
            models.EnableTenantDestinationSecurityTypedDict,
        ],
        destination_id: str,
        tenant_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.EnableTenantDestinationSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def disable(
        ...
        *,
        security: Union[
            models.DisableTenantDestinationSecurity,
            models.DisableTenantDestinationSecurityTypedDict,
        ],
        destination_id: str,
        tenant_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.DisableTenantDestinationSecurity
            ),
            timeout_ms=timeout_ms,
        )
