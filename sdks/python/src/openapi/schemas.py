...
class Schemas(BaseSDK):
    ...
    def list_tenant_destination_types(
        ...
        *,
        security: Union[
            models.ListTenantDestinationTypeSchemasSecurity,
            models.ListTenantDestinationTypeSchemasSecurityTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListTenantDestinationTypeSchemasSecurity
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.DestinationTypeSchema]
            )
    ...
    def get(
        ...
        *,
        security: Union[
            models.GetTenantDestinationTypeSchemaSecurity,
            models.GetTenantDestinationTypeSchemaSecurityTypedDict,
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.GetTenantDestinationTypeSchemaSecurity
            ),
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.DestinationTypeSchema)
        if utils.match_response(http_res, ["401", "403", "407"], "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.UnauthorizedErrorData
            )
    ...
    def list_destination_types_jwt(
        ...
        *,
        security: Union[
            models.ListDestinationTypeSchemasJwtSecurity,
            models.ListDestinationTypeSchemasJwtSecurityTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.ListDestinationTypeSchemasJwtSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def get_destination_type_jwt(
        ...
        *,
        security: Union[
            models.GetDestinationTypeSchemaJwtSecurity,
            models.GetDestinationTypeSchemaJwtSecurityTypedDict,
        ],
        type_: models.GetDestinationTypeSchemaJwtType,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.DestinationTypeSchema:
        r"""Get Destination Type Schema (JWT Auth)
        ...
        request = models.GetDestinationTypeSchemaJwtRequest(
            type=type_,
        )
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetDestinationTypeSchemaJwtSecurity
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="getDestinationTypeSchemaJwt",
                oauth2_scopes=None,
                security_source=security,
            ),
            request=req,
