...
class Events(BaseSDK):
    ...
    def list(
        ...
        *,
        security: Union[
            models.ListTenantEventsSecurity, models.ListTenantEventsSecurityTypedDict
        ],
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListTenantEventsSecurity
            ),
    ...
    def get(
        ...
        *,
        security: Union[
            models.GetTenantEventSecurity, models.GetTenantEventSecurityTypedDict
        ],
        event_id: str,
        tenant_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(security, models.GetTenantEventSecurity),
            timeout_ms=timeout_ms,
        )
    ...
    def list_deliveries(
        ...
        *,
        security: Union[
            models.ListTenantEventDeliveriesSecurity,
            models.ListTenantEventDeliveriesSecurityTypedDict,
        ],
        event_id: str,
        tenant_id: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListTenantEventDeliveriesSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def list_by_destination(
        ...
        *,
        security: Union[
            models.ListTenantEventsByDestinationSecurity,
            models.ListTenantEventsByDestinationSecurityTypedDict,
        ],
        destination_id: str,
        tenant_id: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListTenantEventsByDestinationSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def get_by_destination(
        ...
        *,
        security: Union[
            models.GetTenantEventByDestinationSecurity,
            models.GetTenantEventByDestinationSecurityTypedDict,
        ],
        destination_id: str,
        event_id: str,
        tenant_id: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.GetTenantEventByDestinationSecurity
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def retry(
        ...
        *,
        security: Union[
            models.RetryTenantEventSecurity, models.RetryTenantEventSecurityTypedDict
        ],
        destination_id: str,
        event_id: str,
        tenant_id: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.RetryTenantEventSecurity
            ),
            timeout_ms=timeout_ms,
        )
