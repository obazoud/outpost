...
from openapi.destinations import Destinations
from openapi.events import Events
from openapi.health import Health
from openapi.models import internal
from openapi.publish import Publish
from openapi.schemas import Schemas
from openapi.tenants import Tenants
from openapi.topics_sdk import TopicsSDK
...
class SDK(BaseSDK):
    ...
    def __init__(
        ...
        :param admin_api_key: The admin_api_key required for authentication
        ...
        security: Any = None
        if callable(admin_api_key):
            # pylint: disable=unnecessary-lambda-assignment
            security = lambda: models.Security(admin_api_key=admin_api_key())
        else:
