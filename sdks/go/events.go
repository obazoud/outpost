...
func (s *Events) List(ctx context.Context, security operations.ListTenantEventsSecurity, tenantID *string, destinationID *operations.DestinationID, status *operations.ListTenantEventsStatus, opts ...operations.Option) (*operations.ListTenantEventsResponse, error) {
...
func (s *Events) Get(ctx context.Context, security operations.GetTenantEventSecurity, eventID string, tenantID *string, opts ...operations.Option) (*operations.GetTenantEventResponse, error) {
...
func (s *Events) ListDeliveries(ctx context.Context, security operations.ListTenantEventDeliveriesSecurity, eventID string, tenantID *string, opts ...operations.Option) (*operations.ListTenantEventDeliveriesResponse, error) {
...
func (s *Events) ListByDestination(ctx context.Context, security operations.ListTenantEventsByDestinationSecurity, destinationID string, tenantID *string, status *operations.ListTenantEventsByDestinationStatus, opts ...operations.Option) (*operations.ListTenantEventsByDestinationResponse, error) {
...
func (s *Events) GetByDestination(ctx context.Context, security operations.GetTenantEventByDestinationSecurity, destinationID string, eventID string, tenantID *string, opts ...operations.Option) (*operations.GetTenantEventByDestinationResponse, error) {
...
func (s *Events) Retry(ctx context.Context, security operations.RetryTenantEventSecurity, destinationID string, eventID string, tenantID *string, opts ...operations.Option) (*operations.RetryTenantEventResponse, error) {
