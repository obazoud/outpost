...
func (s *Schemas) ListTenantDestinationTypes(ctx context.Context, security operations.ListTenantDestinationTypeSchemasSecurity, tenantID *string, opts ...operations.Option) (*operations.ListTenantDestinationTypeSchemasResponse, error) {
...
func (s *Schemas) Get(ctx context.Context, security operations.GetTenantDestinationTypeSchemaSecurity, type_ operations.GetTenantDestinationTypeSchemaType, tenantID *string, opts ...operations.Option) (*operations.GetTenantDestinationTypeSchemaResponse, error) {
...
func (s *Schemas) ListDestinationTypesJwt(ctx context.Context, security operations.ListDestinationTypeSchemasJwtSecurity, opts ...operations.Option) (*operations.ListDestinationTypeSchemasJwtResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// GetDestinationTypeJwt - Get Destination Type Schema (JWT Auth)
// Returns the input schema for a specific destination type (infers tenant from JWT).
func (s *Schemas) GetDestinationTypeJwt(ctx context.Context, security operations.GetDestinationTypeSchemaJwtSecurity, type_ operations.GetDestinationTypeSchemaJwtType, opts ...operations.Option) (*operations.GetDestinationTypeSchemaJwtResponse, error) {
	...
	res := &operations.GetDestinationTypeSchemaJwtResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
