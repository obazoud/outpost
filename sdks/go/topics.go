...
func (s *Topics) List(ctx context.Context, security operations.ListTenantTopicsSecurity, tenantID *string, opts ...operations.Option) (*operations.ListTenantTopicsResponse, error) {
...
// ListJwt - List Available Topics (JWT Auth)
// Returns a list of available event topics configured in the Outpost instance (infers tenant from JWT).
func (s *Topics) ListJwt(ctx context.Context, security operations.ListTopicsJwtSecurity, opts ...operations.Option) (*operations.ListTopicsJwtResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.ListTopicsJwtResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
