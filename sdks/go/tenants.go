...
func (s *Tenants) Get(ctx context.Context, security operations.GetTenantSecurity, tenantID *string, opts ...operations.Option) (*operations.GetTenantResponse, error) {
...
func (s *Tenants) Delete(ctx context.Context, security operations.DeleteTenantSecurity, tenantID *string, opts ...operations.Option) (*operations.DeleteTenantResponse, error) {
...
func (s *Tenants) GetPortalURL(ctx context.Context, tenantID *string, theme *operations.GetTenantPortalURLTheme, opts ...operations.Option) (*operations.GetTenantPortalURLResponse, error) {
...
// GetPortalURLJwtContext - Get Portal Redirect URL (JWT Auth Context)
...
func (s *Tenants) GetPortalURLJwtContext(ctx context.Context, theme *operations.GetPortalURLJwtContextTheme, opts ...operations.Option) (*operations.GetPortalURLJwtContextResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/portal")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		BaseURL:        baseURL,
		Context:        ctx,
		OperationID:    "getPortalUrlJwtContext",
		OAuth2Scopes:   []string{},
		SecuritySource: s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetPortalURLJwtContextResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// GetTokenJwtContext - Get Tenant JWT Token (JWT Auth Context)
// Returns a JWT token scoped to the tenant (infers tenant from JWT). Requires Admin API Key.
func (s *Tenants) GetTokenJwtContext(ctx context.Context, opts ...operations.Option) (*operations.GetTenantTokenJwtContextResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.GetTenantTokenJwtContextResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
