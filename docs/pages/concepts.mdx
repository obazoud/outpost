...
Outpost consists of 3 services which can either be run as single deployment or as separate deployments.
...
> Running Outpost as indivual services is optional. You can also run Outpost as a single binary / process if horizontal scaling of the individual services is not need for your event volume.
