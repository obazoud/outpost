...
Outpost has minimal dependencies (Redis, PostgreSQL or Clickhouse, and one of the supported message queues), is 100% backward compatible with your existing webhooks implementation and is optimized for high-throughput, low-cost operation.
...
Learn more about Event Destinations by visiting the [Event Destinations Initiative](https://eventdestinations.org).
